...
| Retorno para rascunho | `retorno_rascunho` | Requisição volta de aguardando autorização para rascunho. | Criador, beneficiário ou chefe do setor do beneficiário | Opcional |
