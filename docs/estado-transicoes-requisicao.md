...
| Retorno para rascunho | `retorno_rascunho` | Requisição volta de aguardando autorização para rascunho; ator é o criador ou o beneficiário ajustando o próprio pedido (TR-006). | Criador ou beneficiário | Opcional |
...
| TR-011 | *(absorvida pela TR-006 como variante de evento, issue #170, decisão de domínio 2026-09-10)* | — | — | "Recusar" deixou de ser um encerramento definitivo separado (`Aguardando autorização -> Recusada`) e virou a variante de TR-006 em que quem decide não é o dono do pedido. Ver TR-006. | — | 1.3, 1.4; PER-03 |
