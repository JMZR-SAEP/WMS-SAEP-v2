...
| Consultar histórico de movimentações | Não | Apenas o que criou | Setor chefiado + o que criou | Sim | Sim | Sim | **Emendado pela #112** (substitui a regra "apenas próprio setor" para o auxiliar, ratificada em grill na US-17 — `.design/movimentacoes-estoque/DESIGN_BRIEF.md`): ser auxiliar não é supervisionar o setor, mesma razão da #106. Chefe e auxiliar entram na página; nenhum dos dois vê saída excepcional nem rascunho. Almoxarifado e superusuário veem tudo. Timeline da requisição segue visibilidade da requisição. |
